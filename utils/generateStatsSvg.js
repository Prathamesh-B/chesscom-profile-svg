    ...
    return `
        <g style='isolation: isolate'>
            ...
            <g transform='translate(${x}, 37)'>
                <text x='0' y='32' stroke-width='0' text-anchor='middle' class="label" stroke='none' font-family='"Segoe UI", Ubuntu, sans-serif' font-weight='500' font-size='18px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards ${delay}s'>
                    ${label}
                </text>
            </g>
            <!-- icon -->
            ...
            <g transform='translate(${x}, 113)'>
                <text x='0' y='32' stroke-width='0' text-anchor='middle' class='number' font-family='"Segoe UI", Ubuntu, sans-serif' font-weight='700' font-size='28px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards ${delay + 0.2}s'>
                    ${value}
                </text>
            </g>
        </g>`;
...
function getRapidIcon() {
    return `<svg width="40" height="40" viewBox="0 0 24 24" class="rapid" fill="none" xmlns="http://www.w3.org/2000/svg" style='opacity: 0; animation: fadein 0.5s linear forwards 0.6s'>
...
function getBulletIcon() {
    return `<svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="38" viewBox="0 0 512 512" xml:space="preserve" style='opacity: 0; animation: fadein 0.5s linear forwards 1s'>
        <g>
            <path class="bullet" d="M495.212,16.785c-44.125-44.141-188.297,5.875-250.078,67.656S61.79,267.8,61.79,267.8l182.406,182.407
...
function getBlitzIcon() {
    return `<svg width="40" height="40" viewBox="0 0 32 32" class="blitz" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style='opacity: 0; animation: fadein 0.5s linear forwards 1.4s'>
